...
export class AddedPenaltySavedEvent1770508951387 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."match_event_type_enum" AS ENUM('GOAL', 'OWN_GOAL', 'YELLOW_CARD', 'RED_CARD', 'GOALKEEPER_SAVE', 'PENALTY_SCORED', 'PENALTY_MISSED', 'PENALTY_SAVE', 'HALF_TIME', 'FULL_TIME')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."match_event_type_enum_old" AS ENUM('GOAL', 'OWN_GOAL', 'YELLOW_CARD', 'RED_CARD', 'GOALKEEPER_SAVE', 'PENALTY_SCORED', 'PENALTY_MISSED', 'HALF_TIME', 'FULL_TIME')`,
    );
    await queryRunner.query(
