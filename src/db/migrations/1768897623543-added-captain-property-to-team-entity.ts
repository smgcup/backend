...
export class AddedCaptainPropertyToTeamEntity1768897623543 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_6c0bde1d2b476889b52cd1a60ae" FOREIGN KEY ("captain_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
