...
export class AddedWeightPrefferedFootAndPositonToThePlayerEntity1767475030912 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."match_event_type_enum" AS ENUM('GOAL', 'YELLOW_CARD', 'RED_CARD', 'GOALKEEPER_SAVE', 'PENALTY_SCORED', 'PENALTY_MISSED', 'HALF_TIME', 'FULL_TIME')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."match_event_type_enum_old" AS ENUM('SHOT', 'GOAL', 'FOUL', 'CARD', 'SUBSTITUTION', 'HALF_TIME', 'PENALTY_SHOOTOUT', 'CORNER_KICK', 'FREE_KICK', 'PENALTY_KICK', 'FULL_TIME')`);
