...
export class ImplementedOwnGoalEvent1769785529427 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."match_event_type_enum" AS ENUM('GOAL', 'OWN_GOAL', 'YELLOW_CARD', 'RED_CARD', 'GOALKEEPER_SAVE', 'PENALTY_SCORED', 'PENALTY_MISSED', 'HALF_TIME', 'FULL_TIME')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."match_event_type_enum_old" AS ENUM('GOAL', 'YELLOW_CARD', 'RED_CARD', 'GOALKEEPER_SAVE', 'PENALTY_SCORED', 'PENALTY_MISSED', 'HALF_TIME', 'FULL_TIME')`);
