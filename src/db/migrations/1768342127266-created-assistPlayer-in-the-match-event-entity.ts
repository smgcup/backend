...
export class CreatedAssistPlayerInTheMatchEventEntity1768342127266 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "match_event" ADD CONSTRAINT "FK_d041c14dc1bfbaf948cbaea4c57" FOREIGN KEY ("assist_player_id") REFERENCES "player"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
